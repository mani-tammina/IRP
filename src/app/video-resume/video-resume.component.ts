...
@Component({
  ...
  styleUrls: ['./video-resume.component.scss']
})
export class VideoResumeComponent {
  ...
  async ngOnInit() {
    navigator.mediaDevices
      ...
      .then(stream => {
        ...
        console.log(this.recordVideoElementRef);
  ...
  startRecording() {
    ...
    console.log("dta event");
    
    console.log(this.onDataAvailableEvent);
